...
STRINGS = {
    "zh": {
        ...
        "success_pins": "成功提取 {} 个引脚。\n{}",

        "no_pins_grid": "没有引脚数据。请先识别一张引脚图。",
        "copied": "已复制 {} 个引脚。切换到 KiCad 符号编辑器按 Ctrl+V 粘贴。",
        "saved": "已保存: {}",
        "exported": "已导出: {}",
    ...
    "en": {
        ...
        "success_pins": "Success: {} pins extracted.\n{}",

        "no_pins_grid": "No pin data. Analyze an image first.",
        "copied": "Copied {} pins. Switch to KiCad Symbol Editor and press Ctrl+V.",
        "saved": "Saved: {}",
        "exported": "Exported: {}",
